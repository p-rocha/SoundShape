...
<!-- badges: start -->
[![R-CMD-check](https://github.com/p-rocha/SoundShape/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/p-rocha/SoundShape/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
Since `SoundShape`'s version 1.3.0, the function `raven.to.wave` allows the creation of `".wav"` files based on selections made using [Raven Pro](https://www.ravensoundsoftware.com/software/raven-pro/), which is commonplace in bioacoustical analysis. Topic 3 below provides information on how to do it.
...
The selection can be performed on numerous softwares of acoustic analysis outside `R` platform (*e.g.* [Audacity](https://www.audacityteam.org/), [Raven Pro](https://www.ravensoundsoftware.com/software/raven-pro/)), or using some functions from [seewave](https://CRAN.R-project.org/package=seewave) and [tuneR](https://CRAN.R-project.org/package=tuneR) packages as exemplified below:
...
```
Alternatively, since `SoundShape`'s version 1.3.0, the function `raven.to.wave` allows the creation of `".wav"` files based on selections made using [Raven Pro](https://www.ravensoundsoftware.com/software/raven-pro/), which is commonplace in bioacoustical analysis. Each selection (i.e. line in table; see `raven.list` documentation) should represent an acoustic unit from the sample study:
